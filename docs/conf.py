# -*- coding: utf-8 -*-
#
# astdoc documentation build configuration file, created by
...
extensions = [
    ...
    'astdoc.ext.autodoc_sections',
    'astdoc.ext.index_styling',
    'astdoc.ext.relbar_toc',
    ]
...
project = u'astdoc'
copyright = u'2010-2011, Assurance Technologies, LLC'
